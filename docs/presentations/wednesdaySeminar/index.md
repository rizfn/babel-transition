...
![bg fit right:40%](../fig/wednesdaySeminar/invasion.png)
...
Higher fit agent replaces the weaker one

Both mutate with rate $\mu$
...
![width:1100px](../fig/wednesdaySeminar/meanfield-orderparams.png)

---

Timeseries: **very fast** switching!

$\\$

![width:800px](../fig/wednesdaySeminar/meanfield-timeseries.png)

---

#### Hysteresis

![width:1100px](../fig/wednesdaySeminar/hysteresis.png)
...
- Origin of Austronesian Language Family

- Island $\implies$ closed system?

- $\approx 20$ languages!

![bg fit right:40%](../fig/wednesdaySeminar/Formosan_Distribution_01.png)

---

**Data** $\qquad\qquad\qquad\qquad\qquad$ **Model**

![width:1100px](../fig/wednesdaySeminar/and_similarity_comparison.svg)