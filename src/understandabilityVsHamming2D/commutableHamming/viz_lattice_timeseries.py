...
def process_lattice_timeseries(L, B, gamma, alpha, mu, K):
    ...
    outdir = f"src/understandabilityVsHamming2D/commutableHamming/plots/latticeAnim/frames/L_{L}_g_{gamma}_a_{alpha}_B_{B}_mu_{mu}_K_{K}"
...
def process_lattice_timeseries_start1(L, B, gamma, alpha, mu, K):
    ...
    outdir = f"src/understandabilityVsHamming2D/commutableHamming/plots/latticeAnim/start1/frames/L_{L}_g_{gamma}_a_{alpha}_B_{B}_mu_{mu}_K_{K}"
