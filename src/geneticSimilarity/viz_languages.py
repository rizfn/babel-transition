...
def umap_clusters_betaNegative(gamma, N, L, mu):
    """Run UMAP first, then clustering with epsilon adjusted by diversity."""
    # Load language data
    ...
    output_file = f"{output_dir}/betaNegative_umap_clusters_g_{gamma}_N_{N}_L_{L}{gen_suffix}.png"
    plt.savefig(output_file, dpi=300, bbox_inches='tight')
    print(f"Visualization saved to: {output_file}")
    plt.show()
...
if __name__ == "__main__":
    ...
    umap_clusters_betaNegative(100, 1000, 16, 0.01)