...
def process_lattice_timeseries(L, B, gamma, alpha, mu, subdir="long"):
    ...
    outdir = os.path.join(base_dir, f"plots/latticeAnim/frames/L_{L}_g_{gamma}_a_{alpha}_B_{B}_mu_{mu}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--mu", type=float, default=0.0001)  # Changed to match your files
