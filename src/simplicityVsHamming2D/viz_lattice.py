...
def plot_lattice_umap_clusters(L, gamma, alpha, mu, K):
    ...
    outname = f"src/simplicityVsHamming2D/plots/lattice/umap_clusters_L_{L}_g_{gamma}_a_{alpha}_mu_{mu}_K_{K}.png"
    plt.tight_layout()
    plt.savefig(outname, dpi=300, bbox_inches='tight')
    plt.show()

if __name__ == "__main__":
    plot_lattice_umap_clusters(100, 0, 1, 0.01, 3)