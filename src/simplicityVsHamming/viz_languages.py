...
def umap_clusters_simplicity_vs_hamming(gamma, alpha, N, beta, L, mu):
    """Run UMAP and cluster for a simplicity-vs-hamming experiment."""
    # Load language data
    base_dir = "src/simplicityVsHamming/outputs/beta/languages"
    languages_file = f"{base_dir}/g_{gamma}_a_{alpha}_N_{N}_b_{beta}_L_{L}_mu_{mu}.tsv"
...
if __name__ == "__main__":
    umap_clusters_simplicity_vs_hamming(0, 1, 1000, 1, 16, 0.01)