...
def hamming_clusters():
    ...
    ax2.set_title(f'UMAP Visualization with Hamming-based Clustering\n'
                 f'{n_clusters} clusters found (γ={gamma}, α={alpha}, threshold={meaningful_diff_bits} bits, {gen_info})')
    ...
    output_file = f"{output_dir}/hamming_clusters_g_{gamma}_a_{alpha}_N_{N}_L_{L}{gen_suffix}.png"
...
def umap_clusters():
    ...
    ax2.set_title(f'UMAP+DBSCAN Clustering\n'
                 f'{n_clusters} clusters found (γ={gamma}, α={alpha}, ' 
