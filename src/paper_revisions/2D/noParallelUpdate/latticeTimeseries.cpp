...
int main(int argc, char *argv[])
{
    ...
    fname << exeDir << "/outputs/latticeTimeseries/L_" << L << "_B_" << B << "/g_" << gamma << "_a_" << alpha << "_mu_" << mu << ".tsv";

    std::filesystem::create_directories(std::filesystem::path(fname.str()).parent_path());
