...
def process_lattice_timeseries(L, B, gamma, alpha, mu, K):
    filename = f"src/cudaUnderstandabilityVsHamming2D/outputs/latticeTimeseries/L_{L}_g_{gamma}_a_{alpha}_B_{B}_mu_{mu}_K_{K}.tsv"
    outdir = f"src/cudaUnderstandabilityVsHamming2D/plots/latticeAnim/frames/L_{L}_g_{gamma}_a_{alpha}_B_{B}_mu_{mu}_K_{K}"
    # filename = f"src/cudaUnderstandabilityVsHamming2D/outputs/latticeTimeseriesCPURepro/L_{L}_g_{gamma}_a_{alpha}_B_{B}_mu_{mu}_K_{K}.tsv"
    # outdir = f"src/cudaUnderstandabilityVsHamming2D/plots/latticeAnimCPURepro/frames/L_{L}_g_{gamma}_a_{alpha}_B_{B}_mu_{mu}_K_{K}"
